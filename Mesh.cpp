...
void Mesh::RenderMeshRange(GLsizei count, GLsizei offset)
{
...
//Dibuja solo un rango de índices (offset a offset+count) en vez del mesh completo,
//permite pintar una sola cara del objeto con un color distinto

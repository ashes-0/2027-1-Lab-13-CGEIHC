...
//Variables para el color random del fondo
float bgR = 0.0f, bgG = 0.0f, bgB = 0.0f;
double ultimoCambio = 0.0; //guarda el tiempo del último cambio de color
const double INTERVALO = 2.0; // 2 segundos entre cambio

//LENGUAJE DE SHADER (SOMBRAS) GLSL
//Vertex Shader
//recibir color, salida Vcolor
//Da la posición de cada vértice de los triángulos (letras) tal cual, sin transformarla
...
//Color fijo (blanco) para cada pixel; por eso TODOS los triángulos (todas las letras) salen del mismo color
...
int main()
{
	...
	// Semilla para que la secuencia de colores random cambie en cada ejecución

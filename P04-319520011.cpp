...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Metemos rotación general de la figura
		...
		*/
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMesh();
		//articulación del  brazo que rota con teclado F
		...
		modelaux = model;
		model = glm::rotate(model, glm::radians(-90.0f),glm::vec3(0.0f, 0.0f, 1.0f));//rotar alrededor de z -90°
		model = glm::scale(model, glm::vec3(0.5f, 4.0f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//articulación 3 rotación con H
		model = modelaux;
		//articulación del  brazo que rota con teclado
		model = glm::translate(model, glm::vec3(2.3f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion3()),glm::vec3(0.0f, 0.0f, 1.0f));//La rotación se maneja en el eje z
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.6f, 0.6f, 0.6f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.5f, 0.5f, 0.5f);
		...
		modelaux = model;
		model = glm::rotate(model, glm::radians(+180.0f), glm::vec3(0.0f, 0.0f, 1.0f));//rotar alrededor de z -90°
		model = glm::scale(model, glm::vec3(0.5f, 1.0f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.71f, 0.49f, 0.86f);//Color lila
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[2]->RenderMeshGeometry();

		//pinza 1
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, 0.5, -0.5f));
		modelaux = model;
		//no necesito un rotate
		model = glm::scale(model, glm::vec3(0.5f, 1.0f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.50f, 1.0f, 0.5f);//Color aqua
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMeshGeometry();

		//pinza 2
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, 0.0, 1.0f));
		modelaux = model;
		//no necesito un rotate
		model = glm::scale(model, glm::vec3(0.5f, 1.0f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.50f, 1.0f, 0.83f);//Color aqua
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMeshGeometry();

		///===============================================
		//Inicio del eje frontal izquierdo
		//Cubo de apoyo que separa al soporte del cuerpo
		model = modelaux2;
		...
		//articulación de 1 de eje frontal  izq
		//A mi consideración no deberia rotar, ya que es un apoyo fijo
		model = modelaux;
		model = glm::translate(model, glm::vec3(-0.8f, 0.0f, 0.0f));
		//model = glm::rotate(model, glm::radians(mainWindow.getarticulacion4()), glm::vec3(0.0f, 0.0f, 1.0f));//La rotación se maneja en el eje z
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.6f, 0.6f, 0.6f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.5f, 0.5f, 0.5f);
		...
		//articulación de 2 de eje frontal izq
		model = modelaux;
		model = glm::translate(model, glm::vec3(-1.5f, -1.5f, 0.0f));
		//model = glm::rotate(model, glm::radians(mainWindow.getarticulacion5()), glm::vec3(0.0f, 0.0f, 1.0f));//La rotación se maneja en el eje z
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.6f, 0.6f, 0.6f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//Parte de pata conexión a la rueda
		model = modelaux;
		model = glm::translate(model, glm::vec3(1.0f, -1.0f, 0.50f));
		modelaux = model;
		...
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion4()), glm::vec3(0.0f, 0.0f, 1.0f));//Se activa con J
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion5()), glm::vec3(0.0f, 0.0f, 1.0f));//Se activa con K rotacion en singular
		modelaux = model;
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(2.5f, 0.5f, 2.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.71f, 0.49f, 0.86f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[2]->RenderMeshGeometry();


		///===============================================
		//Inicio del eje frontal Derecho
		//Se supone que solo bastaría cambiar el eje z
		//Cubo de apoyo que separa al soporte del cuerpo
		model = modelaux2;
		model = glm::translate(model, glm::vec3(-5.0f, 0.0f, -4.5f));
		modelaux = model;
		...
		//articulación de 1 de eje frontal  drch
		//A mi consideración no deberia rotar, ya que es un apoyo fijo
		model = modelaux;
		model = glm::translate(model, glm::vec3(-0.8f, 0.0f, 0.0f));
		//model = glm::rotate(model, glm::radians(mainWindow.getarticulacion4()), glm::vec3(0.0f, 0.0f, 1.0f));//La rotación se maneja en el eje z
		...
		//articulación de 2 de eje frontal drch
		model = modelaux;
		model = glm::translate(model, glm::vec3(-1.5f, -1.5f, 0.0f));
		//model = glm::rotate(model, glm::radians(mainWindow.getarticulacion5()), glm::vec3(0.0f, 0.0f, 1.0f));//La rotación se maneja en el eje z
		modelaux = model;
		...
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -1.25f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion4()), glm::vec3(0.0f, 0.0f, 1.0f));//Se activa con J
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion6()), glm::vec3(0.0f, 0.0f, 1.0f));//Se activa con L rotacion en singular
		modelaux = model;
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(2.5f, 0.5f, 2.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		///===============================================
		//Inicio del eje MEDIO derecho
		//Nos basamos en la estructura forntal pero omitiendo algunas piezas ya que el diagrama que se muestra es  más sencillo
		//Cubo de apoyo que separa al soporte del cuerpo
		model = modelaux2;
		model = glm::translate(model, glm::vec3(-1.0f, 0.0f, -4.5f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.0f, 1.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 1.0f, 1.0f);//blanco
		...
		//articulación de 1 de eje medio drch
		//A mi consideración no deberia rotar, ya que es un apoyo fijo
		model = modelaux;
		model = glm::translate(model, glm::vec3(-0.8f, 0.0f, 0.0f));
		//model = glm::rotate(model, glm::radians(mainWindow.getarticulacion4()), glm::vec3(0.0f, 0.0f, 1.0f));//La rotación se maneja en el eje z
		...
		//Parte de pata superior
		model = modelaux;
		model = glm::translate(model, glm::vec3(-1.4125f, -1.4125f, 0.0f));
		modelaux = model;
		model = glm::rotate(model, glm::radians(-45.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(0.5f, 4.0f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//Articulación de la rodilla (entre pata superior e inferior)
		model = modelaux;
		model = glm::translate(model, glm::vec3(-1.4125f, -1.4125f, 0.0f));
		//model = glm::rotate(model, glm::radians(mainWindow.getarticulacion5()), glm::vec3(0.0f, 0.0f, 1.0f));//La rotación se maneja en el eje z
		modelaux = model;
		...
		//Parte de pata conexión a la rueda
		model = modelaux;
		model = glm::translate(model, glm::vec3(1.4125f, -1.4125f, -0.50f));
		modelaux = model;
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.5f, 2.0f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -1.25f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion4()), glm::vec3(0.0f, 0.0f, 1.0f));//Se activa con J
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion7()), glm::vec3(0.0f, 0.0f, 1.0f));//Se activa con C rotacion en singular
		modelaux = model;
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(2.5f, 0.5f, 2.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		///===============================================
		//Inicio del eje MEDIO IZQ
		//Nuevamente reutilizamos por completo la estrucutura anterior y cambiamos el signo del eje Z
		//Cubo de apoyo que separa al soporte del cuerpo
		model = modelaux2;
		model = glm::translate(model, glm::vec3(-1.0f, 0.0f, 4.5f));
		modelaux = model;
		...
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, 1.25f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion4()), glm::vec3(0.0f, 0.0f, 1.0f));//Se activa con J
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion8()), glm::vec3(0.0f, 0.0f, 1.0f));//Se activa con V rotacion en singular
		modelaux = model;
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(2.5f, 0.5f, 2.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		///===============================================
		//Inicio del eje Trasero izquierdo
		//Se reutilizara la estrcutura del eje medio, con la diferencia de que se rotara 180° sobre eje Y y se trasladara + 3.5f en el eje x
		//La rotación se hace antes del modelaux con el fin de no tener rotar todas y cada unas de las estrcuturas de manera indivudual.
		...
		//articulación de 1 de eje medio izq
		//A mi consideración no deberia rotar, ya que es un apoyo fijo
		model = modelaux;
		model = glm::translate(model, glm::vec3(-0.8f, 0.0f, 0.0f));
		//model = glm::rotate(model, glm::radians(mainWindow.getarticulacion4()), glm::vec3(0.0f, 0.0f, 1.0f));//La rotación se maneja en el eje z
		...
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -1.25f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion4()), glm::vec3(0.0f, 0.0f, 1.0f));//Se activa con J
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion9()), glm::vec3(0.0f, 0.0f, 1.0f));//Se activa con B rotacion en singular
		modelaux = model;
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(2.5f, 0.5f, 2.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		///===============================================
		//Inicio del eje Trasero derecho
		//Se reutilizara la estrcutura y se cambiara el eje z
		//.
		...
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, 1.25f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion4()), glm::vec3(0.0f, 0.0f, 1.0f));//Se activa con J
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion10()), glm::vec3(0.0f, 0.0f, 1.0f));//Se activa con N rotacion en singular
		modelaux = model;
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(2.5f, 0.5f, 2.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		/// Cuerpo de la sonda
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(50.0f, 0.0f, -4.0f)); 
		modelaux = model; //guardamos la matriz de modelo para que la base se mueva con el objeto
		...
		modelaux = model;
		modelaux2 = model;
		model = glm::scale(model, glm::vec3(5.0f, 20.0f, 5.0f)); //20 en Y
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		//la línea de proyección solo se manda una vez a menos que en tiempo de ejecución se programe cambio entre proyección ortogonal y perspectiva
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		...
		//soporte de union con la antena
		model = modelaux;
		...
		modelaux = model; //guardamos la matriz de modelo para conectar los siguientes objetos a la base
		model = glm::scale(model, glm::vec3(7.0f, 2.0f, 2.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.5f, 0.5f, 0.5f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMeshGeometry();
		...
		modelaux = model; //guardamos la matriz de modelo para conectar los siguientes objetos a la base
		model = glm::scale(model, glm::vec3(20.0f, 10.0f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
